...
I am a citizen of the Republic of Korea, and I hope to build long-term international partnerships that support the development of this research institute.
...
AI-assisted ultrasonic technology could provide an alternative low-power communication method, 
helping survival signals remain available for a longer period under certain conditions.

if a person becomes trapped under collapsed buildings following an earthquake, 
AI-assisted ultrasonic signaling could potentially be used to transmit detectable acoustic patterns. 

Search-and-rescue teams equipped with ultrasonic detection devices—or specially equipped 
rescue dogs carrying ultrasonic sensors—could use these signals as an additional aid in locating survivors.
Search-and-rescue dogs may be capable of detecting very faint ultrasonic signals.

By integrating Bluetooth and ultrasonic technologies with AI, 
it may be possible to develop innovative solutions that support emergency response efforts and help save countless lives.

A hybrid approach could use Bluetooth for broad-area discovery and ultrasonic signaling for close-range precision localization of survivors.
